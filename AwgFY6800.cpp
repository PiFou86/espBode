...
/*overwrite*/ AwgFY6900::FY6900WaveType AwgFY6800::MapWaveType(AwgDevice::WaveType waveType)
{
    ...
    if ((awgWaveType == AwgFY6900::FY6900WaveType_UNDEFINED) || (awgWaveType >= AwgFY6800::FY6800WaveType__LAST_))
    {
        // print Error:
        setCh1Output(0);
        setCh2Output(0);
...
FY6800WaveType AwgFY6800::MapWaveType(AwgWaveType waveType)
{
    ...
    case AwgWaveType::AwgWaveType_Sine:
        return FY6800WaveType::FY6800WaveType_Sine;
    case AwgWaveType::AwgWaveType_Square:
        return FY6800WaveType::FY6800WaveType_Square;
    case AwgWaveType::AwgWaveType_Pulse:
        return FY6800WaveType::FY6800WaveType_Impulse; //??
    case AwgWaveType::AwgWaveType_Triangle:
        return FY6800WaveType::FY6800WaveType_Triangle;
    case AwgWaveType::AwgWaveType_DC:
        return FY6800WaveType::FY6800WaveType_DC;
    case AwgWaveType::AwgWaveType_Noise:
        return FY6800WaveType::FY6800WaveType_Noise;
    case AwgWaveType::AwgWaveType_Lorentz:
        return FY6800WaveType::FY6800WaveType_Lorentz;
    case AwgWaveType::AwgWaveType_PosStair:
        return FY6800WaveType::FY6800WaveType_PosStair;
    case AwgWaveType::AwgWaveType_NegStair:
        return FY6800WaveType::FY6800WaveType_NegStair;
    case AwgWaveType::AwgWaveType_ExpFall:
        return FY6800WaveType::FY6800WaveType_PosExp; //??
    case AwgWaveType::AwgWaveType_Partialsine:
        return FY6800WaveType::FY6800WaveType_PosHalfSin; //??
    case AwgWaveType::AwgWaveType_CMOS:
        return FY6800WaveType::FY6800WaveType_CMOS;
    default:
      break;
    }
    return FY6800WaveType::FY6800WaveType_UNDEFINED;
}
