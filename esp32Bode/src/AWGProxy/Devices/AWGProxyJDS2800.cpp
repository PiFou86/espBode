...
bool AWGProxyJDS2800::write(char* data, uint8_t len) {
  uint32_t timeout = 0;
...
bool AWGProxyJDS2800::setCh1Wave(uint8_t wave) {
  char command[] = ":w21=00.\r\n";
...
bool AWGProxyJDS2800::setCh2Wave(uint8_t wave) {
  char command[] = ":w22=00.\r\n";
...
bool AWGProxyJDS2800::setCh1Output(uint32_t output) {
...
bool AWGProxyJDS2800::setCh2Output(uint32_t output) {
...
/* Set frequency in Hz */
bool AWGProxyJDS2800::setCh1Freq(uint32_t frequency) {
...
/* Set frequency in Hz */
bool AWGProxyJDS2800::setCh2Freq(uint32_t frequency) {
...
bool AWGProxyJDS2800::setCh1Ampl(uint32_t ampl) {
...
bool AWGProxyJDS2800::setCh2Ampl(uint32_t ampl) {
...
bool AWGProxyJDS2800::setCh1Phase(uint32_t phase) {
...
bool AWGProxyJDS2800::setCh2Phase(uint32_t phase) {
...
bool AWGProxyJDS2800::setCh1Offset(int32_t offset) {
...
bool AWGProxyJDS2800::setCh2Offset(int32_t offset) {
...
bool AWGProxyJDS2800::begin(void) {
