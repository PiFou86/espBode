...
void AWGProxyFY6800::fy6800_write(char* data, uint8_t len)
{
    uint32_t timeout = 0;
...
void AWGProxyFY6800::setCh1Wave(EWaveType wave)
{
    char command[] = "WMW00\n";
...
void AWGProxyFY6800::setCh2Wave(EWaveType wave)
{
    char command[] = "WFW00\n";
...
void AWGProxyFY6800::setCh1Output(uint32_t output)
{
    if(output)
    {
...
void AWGProxyFY6800::setCh2Output(uint32_t output)
{
    if(output)
    {
...
/* Set frequency in Hz */
void AWGProxyFY6800::setCh1Freq(uint32_t frequency)
{
...
/* Set frequency in Hz */
void AWGProxyFY6800::setCh2Freq(uint32_t frequency)
{
...
void AWGProxyFY6800::setCh1Ampl(uint32_t ampl)
{
...
void AWGProxyFY6800::setCh2Ampl(uint32_t ampl)
{
...
void AWGProxyFY6800::setCh1Phase(uint32_t phase)
{
...
void AWGProxyFY6800::setCh2Phase(uint32_t phase)
{
...
void AWGProxyFY6800::setCh1Offset(int32_t offset)
{
...
void AWGProxyFY6800::setCh2Offset(int32_t offset)
{
...
void AWGProxyFY6800::initDevice(void)
{
